...
exports.getRolePermissions = async (role_hndlr, permission_key) => {
    log('in getRolePermissions');
    log(`checking '${permission_key}' object on '${role_hndlr}' role.`);
